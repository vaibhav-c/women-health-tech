...
public class AdapterPrescriptionPaid extends RecyclerView.Adapter<AdapterPrescriptionPaid. Holder> {

    Context context;
    int resource;
    ArrayList<Prescription> ArrayList;

    public AdapterPrescriptionPaid(Context context, int resource, ArrayList<Prescription>  ArrayList) {
    ...
    @NonNull
    @Override
    public AdapterPrescriptionPaid. Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AdapterPrescriptionPaid. Holder(LayoutInflater.from(context).inflate(resource,parent,false));

    }

    @Override
    public void onBindViewHolder(@NonNull AdapterPrescriptionPaid. Holder holder, int position) {
